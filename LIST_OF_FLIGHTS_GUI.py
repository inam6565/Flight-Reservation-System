...
#Top Status bar
status=Label(mainfame,text=" List of Flights",image=f112,compound=LEFT,bg="white",fg="#0c26af",bd=10,relief=FLAT,anchor=W)
...
detail_button=Button(line3,text="Details",bg="#0c26af",fg="white",bd=0,padx=20,pady=10,command=info)
