...
#Top Status bar
status=Label(mainfame,text=" View Booking Details ",image=f130,compound=LEFT,bg="#ffffff",fg="#0c26af",bd=10,relief=FLAT,anchor=W)
...
ticketno=Label(line3,text="Enter your Ticket no : ",font=("Arial",14),image=f128,bg="#0c26af",compound=LEFT,fg="white",padx=10,pady=5)
...
book_button=Button(line3,text="  View Booking Details  ",bg="#ffffff",fg="#0c26af",padx=5,pady=5,bd=0,command=viewbookingdetails)
